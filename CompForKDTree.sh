...
gcc -g ./unit_tests/KDTree_unit_test.c KDTree.c KDArray.c SPPoint.c KDTree.h KDArray.h SPPoint.h ./unit_tests/unit_test_util.h -o KDTreeTester -lm -Werror -pedantic-errors -DNDEBUG
